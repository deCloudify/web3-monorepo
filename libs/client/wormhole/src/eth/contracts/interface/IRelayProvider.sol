...
/** this interface will be used by the Account.sol in order to define the price that is to be paid by the Paymaster 
for the userOp created on the various DeFI / DEX platforms (for generalized message/ token transfers).
*/
